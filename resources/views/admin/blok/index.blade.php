        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Blok</div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" id="table-1">
                                        <thead>
                                            <tr>
                                                <th class="text-center">ID Blok</th>
                                                <th>Nama Blok</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($blok as $data)
                                                <tr>
                                                    <td class="text-center">{{ $data->id_blok }}</td>
                                                    <td>{{ $data->nama_blok }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.blok.edit', $data->id_blok) }}"
                                                            class="btn btn-warning">Edit</a>
                                                        <form action="{{ route('admin.blok.destroy', $data->id_blok) }}"
