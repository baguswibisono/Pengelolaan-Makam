                                    ...
                                    <table class="table" id="table-1">
                                        ...
                                        <tbody>
                                            @foreach ($lokasi as $data)
                                                <tr>
                                                    <td class="text-center">{{ $data->id_lokasi }}</td>
                                                    <td>{{ $data->blok->nama_blok }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.lokasi.edit', $data->id_lokasi) }}"
                                                            class="btn btn-warning">Edit</a>
                                                        <form action="{{ route('admin.lokasi.destroy', $data->id_lokasi) }}"
