        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Sedekah</div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" id="table-1">
                                        <thead>
                                            <tr>
                                                <th class="text-center">ID Sedekah</th>
                                                <th>Nama</th>
                                                <th>Tanggal Sedekah</th>
                                                <th>Status</th>
                                                <th>Bukti Sedekah</th>
                                                <th>Action</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            @foreach ($sedekah as $data)
                                                <tr>
                                                    <td class="text-center">{{ $data->id_sedekah }}</td>
                                                    <td>{{ $data->nama }}</td>
                                                    <td>{{ $data->tanggal }}</td>
                                                    ...
                                                    <td>
                                                        @if ($data->status !== 'terbayar')
                                                            <form
                                                                action="{{ route('admin.sedekah.confirm', $data->id_sedekah) }}"
                                                        ...
                                                        @endif
                                                        <form
                                                            action="{{ route('admin.sedekah.destroy', $data->id_sedekah) }}"
                                                            method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
