...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/sedekah', 'sedekah')->name('sedekaah');
    Route::post('/sedekah', 'sedekahSubmit')->name('sedekah.submit');
});
...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::resource('sedekah', Admin\SedekahController::class)->parameter('sedekah', 'sedekah');
    ...
    Route::patch('sedekah/{sedekah}/confirm', [Admin\SedekahController::class, 'confirm'])->name('sedekah.confirm');
